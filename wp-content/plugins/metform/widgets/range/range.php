		...
		<div className="mf-input-wrapper">
			...
			?>
				<${props.InputRange}
					...
					ref=${input => !parent.state.formData['<?php echo esc_attr($mf_input_name); ?>'] ? parent.state.formData['<?php echo esc_attr($mf_input_name); ?>'] = <?php echo json_encode($multipile_value); ?> : ''}
				...
				<?php } else { ?>
					<${props.InputRange}
						...
						value=${<?php 
							...
							<?php }
						?>}
						ref=${input => !parent.state.formData['<?php echo esc_attr($mf_input_name); ?>'] ? parent.state.formData['<?php echo esc_attr($mf_input_name); ?>'] = '<?php echo $default_value; ?>' : ''}
						name="<?php echo esc_attr($mf_input_name); ?>" 
						/>
				<?php } ?>
			</div>

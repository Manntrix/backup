(function( $ ) {
    ...
    jQuery( document ).ready( function() {
        ...
        // Code mirror init
        if ( document.getElementById( 'wws_custom_css' ) ) {
            var wwsAdminCustomCSSTextarea = CodeMirror.fromTextArea( document.getElementById( 'wws_custom_css' ), {
                mode: 'css',
                theme: 'dracula',
                lineNumbers: true,
            } );
            wwsAdminCustomCSSTextarea.setSize( null, 300 );
        }
